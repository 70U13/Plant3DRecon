...
cam_calibration_dir_path = os.path.abspath("./GEN_3D_plants/calibration_images")
stereo_images_dir_path = "C:\\Users\\Kaye Louise\\Desktop\\research\\GEN_3D_plants\\sample_platform-small"
...
def get_image_pairs(dir_path: str, left_substr="leftcam", right_substr="rightcam"): 
