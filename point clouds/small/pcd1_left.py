...
file_path = r"C:\Users\Kaye Louise\Desktop\research-3D\GEN_3D_Plants\point clouds\small\.ply1.ply_.plyL.plyC.ply..plyj.plyp.plyg.ply"         
pcd1 = o3d.io.read_point_cloud(file_path)
#pcd1 = o3d.io.read_point_cloud(".ply1.ply_.plyL.plyC.ply..plyj.plyp.plyg.ply") 
...
down_pcd = pcd1.voxel_down_sample(voxel_size=1)
...
radii = o3d.utility.DoubleVector([avg_distance, avg_distance * 2, avg_distance * 4])
